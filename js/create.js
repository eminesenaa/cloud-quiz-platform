...
function addQ(initData) {
  ...
  const opts =
    initData && initData.options ? initData.options : ["", "", "", ""];
  ...
  <div class="qfoot-actions">
    ...
    <button class="qdel" onclick="delQ(this)">
...
function collectQuiz() {
  ...
  for (const c of cards) {
    ...
    if (!rb) {
      toast("Select the correct answer for each question");
      return null;
    }
